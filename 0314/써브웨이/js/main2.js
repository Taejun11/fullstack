$(function(){
    ...
    $(window).scroll(function(){
        ...
        if (c1 <= sct + 700) {
            $('.s4_title img').addClass('s4_help');
        }
        if (c2 <= sct + 700) {
            $('.s4_title h2').addClass('s4_help');
        }
        if (c3 <= sct + 700) {
            $('.s4_title p').addClass('s4_help');
        }
        if (c4 <= sct + 700) {
            setTimeout(function(){
                $('.s4_table li').eq(0).addClass('s4_help');
            }, 300);
            setTimeout(function(){
                $('.s4_table li').eq(1).addClass('s4_help');
            }, 600);
            setTimeout(function(){
                $('.s4_table li').eq(2).addClass('s4_help');
            }, 900);
            setTimeout(function(){
                $('.s4_table li').eq(3).addClass('s4_help');
            }, 1200);
        }
        // 여기까지 s4
